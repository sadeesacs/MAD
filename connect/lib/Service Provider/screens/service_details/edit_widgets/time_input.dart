        ...
        Expanded(
          child: TextField(
            ...
            decoration: InputDecoration(
              hintText: 'From',
              hintStyle: const TextStyle(fontSize: 18, color: Color(0xFF838383)),
            ...
            onTap: () async {
              ...
              if (picked != null) {
                ...
                setState(() => _fromController.text = formatted);
        ...
        Expanded(
          child: TextField(
            ...
            onTap: () async {
              ...
              if (picked != null) {
                final formatted = _formatTime(picked);
                setState(() => _toController.text = formatted);
                widget.onTimeSelected(_fromController.text.trim(), formatted);
              }
            },
          ),
        ),
